...
plot(noise_snr_all(1,[1:4 6:end]),accuracy_validation_mean(:,[1:4 6:end],1),'LineWidth',3);
...
plot(noise_snr_all(1,[1:4 6:end]),min(accuracy_validation_mean(:,[1:4 6:end],1)+accuracy_validation_std(:,[1:4 6:end],1),100),'LineStyle','none','LineWidth',2)
plot(noise_snr_all(1,[1:4 6:end]),max(accuracy_validation_mean(:,[1:4 6:end],1)-accuracy_validation_std(:,[1:4 6:end],1),0),'LineStyle','none','LineWidth',2)
patch([noise_snr_all(1,[1:4 6:end]) fliplr(noise_snr_all(1,[1:4 6:end]))], [min(accuracy_validation_mean(:,[1:4 6:end],1)+accuracy_validation_std(:,[1:4 6:end],1),100) fliplr(max(accuracy_validation_mean(:,[1:4 6:end],1)-accuracy_validation_std(:,[1:4 6:end],1),0))], 'y','FaceAlpha',0.2)
hold off
ax = gca;
ax.FontSize = 15;
